...
/*!
 @abstract The quality analysis processed image.
 */
@property (nonatomic, strong) UIImage* qualityImageProcessed;

/*!
 @abstract The quality analysis processed image from the back side of the document.
 */
@property (nonatomic, strong) UIImage* qualityImageProcessedBack;

/*!
 @abstract Data from the quality analysis
 */
@property (nonatomic, strong) DMDSResultQuality* qualityData;

/*!
 @abstract Data from the quality analysis
 */
@property (nonatomic, strong) DMDSResultQuality* qualityDataBack;
...
qualityImageProcessed:(UIImage*)qualityImageProcessed
       qualityData:(DMDSResultQuality*)qualityData
qualityImageProcessedBack:(UIImage*)qualityImageProcessedBack
   qualityDataBack:(DMDSResultQuality*)qualityDataBack
