...
static NSString* const kQualityResultImageScoreKey              = @"result.image.quality.score";
static NSString* const kQualityResultImageBestScoreKey          = @"result.image.best.score";
...
/*!
 @brief Get the overall face quality score for the frame,
 @description faceImageScore = EyesFoundConfidence * EyesOpenConfidence + Global Quality Score
 */
@property (nonatomic, readonly) float faceImageScore;
