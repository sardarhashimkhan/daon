...
/*!
 @brief Empty method which should be implemented by all sub-classes to create the @link DASAuthenticatorContext @/link for the concrete authenticator and begin presentation using @link attemptUIPresentationt: @/link.
