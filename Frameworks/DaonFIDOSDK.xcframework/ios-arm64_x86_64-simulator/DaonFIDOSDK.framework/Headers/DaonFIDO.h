...
/*!
 ...
 @param enabled if true, logging will be enabled.
 */
+ (void) setLoggingEnabled:(BOOL)enabled NS_SWIFT_NAME(setLogging(enabled:));

/*!
 @brief Enable or disable runtime logging at a given level.
 @param enabled if true, logging will be enabled.
 @param level IXALogLevelError, IXALogLevelInfo or IXALogLevelDebug.
 */
...
/*!
 ...
 @param enabled if true, logging will be enabled.
 @param level IXALogLevelError, IXALogLevelInfo or IXALogLevelDebug.
 @param persist if true, the log will also be written to a file, daon-ixa.log in the apps document folder.
 */
