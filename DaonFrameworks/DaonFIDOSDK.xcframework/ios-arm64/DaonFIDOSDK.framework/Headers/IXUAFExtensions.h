...
static NSString * const kIntegrityDetectionExtension    = @"com.daon.sdk.integrity";
...
static NSString * const kExcludeInvalidAuthenticatorsExtension = @"com.daon.sdk.exclude.invalidAuthenticators";
...
- (void) initializeWithExtensions:(NSArray<NSDictionary*>*)extensions cache:(BOOL)cache;

- (NSError*) finalizeExtensionsWithApplication:(NSString*)appid
                                      username:(NSString*)username
                                      registry:(IXUAFAuthenticatorRegistry*)registry
                                     encryptor:(IXUAFCaptureDataEncryptor*)encryptor;
