...
@protocol DMDSCameraFlowControllerDelegate;
@protocol DMDSCameraViewControllerDelegate;
...
@class DMDSCameraFlowController;
@class DMDSCameraViewController;
@class DMDSOptions;
@class DMDSMetadataProvider;
...
@property (nonatomic, weak) DMDSMetadataProvider* _Nullable metadataProvider __attribute__((deprecated("metadataProvider is deprecated and will be removed in a future release.")));
@property (nonatomic, readonly) UIViewController* _Nullable cameraViewController;
