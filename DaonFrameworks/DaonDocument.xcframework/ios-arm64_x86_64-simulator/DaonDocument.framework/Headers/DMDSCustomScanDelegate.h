...
#import "DMDSDocumentDetectionStatus.h"
...
/*!
 @abstract Called when the scanning session has helpful feedback for the user on the current document detection process.
 This occurs during the scanning session (prior to the scanning session producing the final results and calling the documentScannedWithResult: delegate method).

 @param detectionStatus  Detection feedback enum (@link DMDSDocumentDetectionStatus.h DMDSDocumentDetectionStatus @/link) containing the user feedback.
 */
- (void) documentDetectionStatus:(DMDSDocumentDetectionStatus)detectionStatus;
 ...
 */
- (void) documentScanFailedWithError:(NSError*)error __attribute__((deprecated("documentScanFailedWithError: is deprecated and will be removed in a future release.")));
 ...
 */
- (void) didDetectGlareWithResult:(BOOL)glare __attribute__((deprecated("didDetectGlareWithResult: is deprecated and will be removed in a future release.")));
